const allSubjects = ["Applied Physics", "Programming Fundamentals", "Introduction to Logics", "Introduction to Communication and Information", "English Composition and Comprehension"];
const inputTypeList = ["Assignments", "Quizes", "Mid", "Final", "Project", "Lab"];
...
function updateMax(element) {
  if (!(document.getElementById("change-txt").value === "")) {
    changingSubject.max[changingIndex] = Number(document.getElementById("change-txt").value);
